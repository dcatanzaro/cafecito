    ...
    return (
        <div className={style.postContainer}>
            <div className={style.post}>
                <p>
                    Hola! Soy <strong>Damián Catanzaro</strong>, actualmente
                    trabajo como Tech Lead en Digiventures, una startup FinTech.
                </p>

                <p>
                    💻 Estoy hace más de 10 años trabajando en el mundo de
                    sistemas, principalmente centrado en lo que es web, tanto
                    desarrollo FrontEnd como BackEnd.
                </p>

                <p>
                    A principio de este año me propuse hacer crecer mi perfil
                    ayudando a la comunidad de sistemas, para esto creé un blog
                    en donde estoy subiendo serie de tutoriales, ya sean desde 0
                    o avanzados, para todos los niveles.
                </p>
                ...
                <p>
                    Si querés ver, clonarte o aportar a algunos de estos
                    proyectos, están todos en mi{" "}
                    <a href="https://github.com/dcatanzaro">GitHub</a>.
                </p>

                <p>
                    Si tenés ganas de darme una mano podés regalarme un café ☕️
                    y te lo super voy a agradecer! ❤️
                </p>
                <p>
                    Y si querés podés dejar tu nombre y un mensaje para que
                    quede guardado y sepa quien me está ayudando!
                </p>
            </div>
        </div>
    );
